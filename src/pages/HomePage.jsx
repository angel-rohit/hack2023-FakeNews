      ...
      <div class="flex items-center border border-skin-overlapMuted rounded p-4 mt-4">
        ...
        <div class="w-[92%]">
          <div class="flex items-center">
            <span class="text-base font-semibold text-skin-blue">Title</span>
          </div>
          <p class="text-sm text-skin-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut nibh tellus, tincidunt at dolor vel, mattis laoreet augue. Morbi ac erat id odio porta commodo ac quis ante. Phasellus eget commodo purus. Nullam rutrum ultricies arcu, at gravida nunc. Ut at nulla metus. Phasellus porta dui vitae diam pretium, et vulputate sem hendrerit.</p>
          ...
          <div class="flex items-center text-xs font-medium mt-1">
            ...
            <div class="text-skin-blue flex items-center">
              <span class="mx-0.5 font-medium">Like</span>
